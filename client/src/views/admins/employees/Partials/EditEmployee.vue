...
<template>
    ...
    <Modal :show="showEditModal" @close="closeEditModal">
        <div class="bg-white p-8 rounded-2xl shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <form @submit.prevent="updateEmployee" class="grid grid-cols-2 gap-6">
                <!-- Basic Information -->
                ...
                <div class="col-span-2">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="space-y-1">
                            <label for="deductions.sss" class="text-sm font-medium text-gray-700">SSS Deduction</label>
                        ...
                        <div class="space-y-1">
                            <label for="deductions.philHealth" class="text-sm font-medium text-gray-700">PhilHealth
                                Deduction</label>
                            <input v-model.number="form.deductions.philHealth" type="number" id="deductions.philHealth"
                                class="block w-full p-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                min="0" />
                        </div>
                        <div class="space-y-1">
